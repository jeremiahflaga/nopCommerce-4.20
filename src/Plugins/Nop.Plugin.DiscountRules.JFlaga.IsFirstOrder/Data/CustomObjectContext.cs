...
{
    public partial class CustomObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public CustomObjectContext(DbContextOptions<CustomObjectContext> options) : base(options)
        {
        }
        ...
        {
            modelBuilder.ApplyConfiguration(new CustomTableMap());
        ...
        {
            //drop the table
            this.DropPluginTable(nameof(CustomTableMap));
        }
