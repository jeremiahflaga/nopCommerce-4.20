...
namespace Nop.Plugin.DiscountRules.JFlaga.IsFirstOrder
{
    public class IsFirstOrderDiscountRequirementRule : BasePlugin, IDiscountRequirementRule
    {
        ...
        #region Ctor
        public IsFirstOrderDiscountRequirementRule(
        ...
        public DiscountRequirementValidationResult CheckRequirement(DiscountRequirementValidationRequest request)
        {
            ...
            var isFirstOrderRuleApplied = _settingService.GetSettingByKey<bool>(string.Format(DiscountRequirementDefaults.SETTINGS_KEY, request.DiscountRequirementId));
